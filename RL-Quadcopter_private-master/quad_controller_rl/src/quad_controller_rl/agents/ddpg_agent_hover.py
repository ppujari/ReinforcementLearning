...
class DDPGHover(BaseAgent):
    ...
    def __init__(self, task):
        ...
        self.hidden_units = 3
        self.gamma = 1.0
        self.bias_initializer_actor = Constant(0.6)

        # noise parameters
        self.noise_process = np.zeros(self.action_size)
        self.noise_scale = 0.2 * (self.action_range[2]) * np.ones(self.action_size)
        ...
        self.actor_path = '/home/robond/catkin_ws/src/RL-Quadcopter/hover_actor.h5'
        self.critic_path = '/home/robond/catkin_ws/src/RL-Quadcopter/hover_critic.h5'
        self.output_path = '/home/robond/catkin_ws/src/RL-Quadcopter/hover_output.txt'
